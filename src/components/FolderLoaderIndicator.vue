<template>
  <div class="vuefinder__folder-loader-indicator">
    ...
    <div class="vuefinder__folder-loader-indicator--icon" v-else>
      <Icon icon="square_minus" class="vuefinder__folder-loader-indicator--minus" v-if="opened && getLoadedFolder()?.folders.length" />
      <Icon icon="square_plus" class="vuefinder__folder-loader-indicator--plus" v-if="!opened" />
    </div>
